...
**Progress: 679 / 705 programmes translated** (verified via `select count(*) filter (where i18n is not null) from public.programmes`). Scholarships: **0 / 197**. The mechanism is fully built and proven (see the "Catalogue i18n engine" section below). To continue, repeat this loop:

...
wider net than the earlier top-50-only audits). **Current state: 1219 programmes, max id 1244, max rank
1215** (verified live in Supabase). All rows added so far are translated (nl/fr/de/es) — re-run the

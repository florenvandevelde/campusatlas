...
wider net than the earlier top-50-only audits). **Current state: 1329 programmes, max id 1354, max rank
1325** (verified live in Supabase). Eighth confirmed goldmine: `universityofgalway.ie` (native EUR, no

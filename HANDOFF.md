...
wider net than the earlier top-50-only audits). **Current state: 1342 programmes, max id 1367, max rank
1338** (verified live in Supabase). Maynooth's PDF fee list is unreachable both ways (WebFetch 403s it, the

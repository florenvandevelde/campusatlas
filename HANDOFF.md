...
wider net than the earlier top-50-only audits). **Current state: 1217 programmes, max id 1242, max rank
1213** (verified live in Supabase). All rows added so far are translated (nl/fr/de/es) — re-run the

...
wider net than the earlier top-50-only audits). **Current state: 1201 programmes, max id 1226, max rank
1197** (verified live in Supabase). All rows added so far are translated (nl/fr/de/es) — re-run the

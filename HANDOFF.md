...
wider net than the earlier top-50-only audits). **Current state: 1365 programmes, max id 1390, max rank
1361** (verified live in Supabase). Maynooth's PDF fee list is unreachable both ways (WebFetch 403s it, the

...
wider net than the earlier top-50-only audits). **Current state: 1293 programmes, max id 1318, max rank
1289** (verified live in Supabase). 717 short of the new 2000 target. Fourth confirmed goldmine found:

...
wider net than the earlier top-50-only audits). **Current state: 1392 programmes, max id 1417, max rank
1388** (verified live in Supabase). Kent (iframe-embedded fee table) and Reading (flat rate categories only,

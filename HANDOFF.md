...
wider net than the earlier top-50-only audits). **Current state: 1215 programmes, max id 1240, max rank
1211** (verified live in Supabase). All rows added so far are translated (nl/fr/de/es) — re-run the

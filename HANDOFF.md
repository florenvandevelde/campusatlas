...
wider net than the earlier top-50-only audits). **Current state: 1207 programmes, max id 1232, max rank
1203** (verified live in Supabase). All rows added so far are translated (nl/fr/de/es) — re-run the

...
wider net than the earlier top-50-only audits). **Current state: 1220 programmes, max id 1245, max rank
1216** (verified live in Supabase). All rows added so far are translated (nl/fr/de/es) — re-run the

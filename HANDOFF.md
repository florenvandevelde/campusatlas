...
wider net than the earlier top-50-only audits). **Current state: 1352 programmes, max id 1377, max rank
1348** (verified live in Supabase). Maynooth's PDF fee list is unreachable both ways (WebFetch 403s it, the

...
wider net than the earlier top-50-only audits). **Current state: 1214 programmes, max id 1239, max rank
1210** (verified live in Supabase). All rows added so far are translated (nl/fr/de/es) — re-run the

...
wider net than the earlier top-50-only audits). **Current state: 1385 programmes, max id 1410, max rank
1381** (verified live in Supabase). Third self-caught bug this session: a school-attribution mix-up

...
wider net than the earlier top-50-only audits). **Current state: 1356 programmes, max id 1381, max rank
1352** (verified live in Supabase). Maynooth's PDF fee list is unreachable both ways (WebFetch 403s it, the

...
wider net than the earlier top-50-only audits). **Current state: 1212 programmes, max id 1237, max rank
1208** (verified live in Supabase). All rows added so far are translated (nl/fr/de/es) — re-run the

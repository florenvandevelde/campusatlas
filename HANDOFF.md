...
wider net than the earlier top-50-only audits). **Current state: 1363 programmes, max id 1388, max rank
1359** (verified live in Supabase). Maynooth's PDF fee list is unreachable both ways (WebFetch 403s it, the

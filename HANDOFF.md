...
wider net than the earlier top-50-only audits). **Current state: 1360 programmes, max id 1385, max rank
1356** (verified live in Supabase). Maynooth's PDF fee list is unreachable both ways (WebFetch 403s it, the
